...
const RoadmapComp = () => {
  return (
    <Container className="roadmap-comp comp-height" fluid>
      <Container className="roadmap-comp-container">
        <TitleComp title={"ROADMAP"}/>
        <VerticalTimeline className="roadmap-comp-content" animate={false}>
          ...
          >
            ...
            <p>- Keep up with the flock in the Discord channel and the Pigeonheads with the most engagement will be
              eligible to receive 2 Ethereum rewards.</p>
            <p>- 5 new item will also drop to 5 lucky token holders to accessorize their look.</p>
            <p>- We will announce at least 20 giveaways, with winners selected from participants in our Discord and
              Twitter channels. The winners will be rewarded with their own Pigeonhead NFT on the Launch day.</p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
            contentStyle={{background: "#45aaf2", color: "#fff"}}
          ...
          >
            ...
            <p>To celebrate our halfway mark, and show our appreciation, we will be making a $20,000
              charity donation to <i style={{fontStyle: "italic"}}>Its from the Sole</i>, a non-for-profit organization
              focused on collecting,
              refurbishing and giving away shoes to the homeless in New York City and other
              metropolitan areas, as well as a $20,000 donation to <i style={{fontStyle: "italic"}}>InspiraBag</i>, a
              community driven
          ...
          >
            ...
            <p>- Our giveaways intensify with the first cold wallet drop in New York City, including one-of-a-kind
              items, up to 5 Ethereum and much more.</p>
            <p>- Geodrops are unlocked. Murals with embedded AR will be unveiled in New York, LA and Miami, which will
              be auctioned as NFTs.</p>
